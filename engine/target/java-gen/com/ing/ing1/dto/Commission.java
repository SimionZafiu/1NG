...
public class Commission {
    ...
    private Currency_____ currency;
    @JsonIgnore
     ...
     */
    @JsonProperty("currency")
    public Currency_____ getCurrency() {
        return currency;
    }
     ...
     */
    @JsonProperty("currency")
    public void setCurrency(Currency_____ currency) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Commission) == false) {
            return false;
        }
        Commission rhs = ((Commission) other);
