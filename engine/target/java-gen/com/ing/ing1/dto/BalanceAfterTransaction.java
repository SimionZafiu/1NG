...
public class BalanceAfterTransaction {
    ...
    private Currency______ currency;
    @JsonIgnore
     ...
     */
    @JsonProperty("currency")
    public Currency______ getCurrency() {
        return currency;
    }
     ...
     */
    @JsonProperty("currency")
    public void setCurrency(Currency______ currency) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BalanceAfterTransaction) == false) {
            return false;
        }
        BalanceAfterTransaction rhs = ((BalanceAfterTransaction) other);
